<script lang="ts">
  ...
  const questions: Array<{
  ...
  }> = [
    {
      ...
      options: [
        { value: 'morning', title: 'صبح زود', description: 'برای شروع جدی روز', icon: '☀️' },
        { value: 'day', title: 'صبح و وسط روز', description: 'همراه کار و تمرکز', icon: '◐' },
        { value: 'afternoon', title: 'عصر', description: 'هنوز قهوه می‌خوام، ولی سبک‌تر', icon: '🌤' },
        { value: 'night', title: 'شب', description: 'بیشتر برای حال و مزه', icon: '☾' }
      ]
    },
    {
      key: 'effect',
